...
urlpatterns = [
    ...
    path('odd15/', views.oddArea, name='odd15'),
    path('odd15/detail_cible/<str:v>/', views.detail_cible, name='detail_cible'),
    path('odd15/sous_indicateur_detail/<str:v>/', views.sous_indicateur_detail, name='sous_indicateur_detail'),
